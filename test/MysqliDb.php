...
class MysqliDb {
	 ...
	 *        	The desired column
	 * @param int $limit
	 *        	Limit of rows to select. Use null for unlimited..1 by default
	 *        	
	...
	/**
	 * Update query.
	 * Be sure to first call the "where" method.
	 *
	 * @param string $tableName
	 *        	The name of the database table to work with.
	 ...
	 * @param string $cond
	 *        	Condition of where statement (OR, AND)
	 *        	
	 * @return MysqliDb
	 */
	 ...
	 *        	Comparison operator. Default is =
	 * @param string $cond
	 *        	The conditional operator which is used. Default is AND
	 *        	
	 * @return MysqliDb
	 */
	 ...
	 * global mysqli.reconnect set to true).
	 * Can't do this directly using object
	 ...
	 *        	Prefix to strip from the path in exec log
	 *        	
	 * @return MysqliDb
	 */
	 ...
	 *
	 * @param array $tables
	 *        	Table name or an Array of table names to check
	 *        	
	 ...
	 *        	field name to use for a mapped element key
	 *        	
	 * @return MysqliDb
	 */
	 ...
	 *        	Array or coma separated list of fields to fetch
	 * @return array
	 */
